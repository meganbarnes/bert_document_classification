...
from bert_document_classification.document_distilbert import BertForDocumentClassification
...
if __name__ == "__main__":
    ...
    train, dev = load_goc(partition='TRAINING_SET'), load_goc(partition='DEV_SET')
